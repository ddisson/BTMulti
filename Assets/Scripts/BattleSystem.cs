...
public class BattleSystem : MonoBehaviour
{
    ...
    //[SerializeField] GameObject[] enemyBodyParts; // no use
    //[SerializeField] GameObject[] playerBodyParts; // no use
    ...
    public SkillSO[] attackingSkillList = new SkillSO[10]; // no use
    public SkillSO[] blockingSkillList = new SkillSO[10]; // no use

    private bool attacking; //no use
    private bool blocking; // no use
    
    [SerializeField] Dictionary<BodyPart, AttackingSkill[]> playerAttackDictionary = new Dictionary<BodyPart, AttackingSkill[]>(); // no use
    [SerializeField] Dictionary<BodyPart, BlockingSkill[]> playerBlockDictionary = new Dictionary<BodyPart, BlockingSkill[]>(); // no use
    ...
    //private UnityAction CancelButton;

    //private void buttonCallBack(int index)
    //{
    //    Debug.Log("Button Clicked. Received string: " + index + " with int: " );
    //}
    ...
    public void OnConfirmBtn()
    {
        ...
        //SendSkills();
        //damageSystem.PlayerResult();
        //CreateEnemyActions(); //already created for test
        //RoundResult();
        //EnemySkillChoice();
        //damageSystem.TestAtDic();
